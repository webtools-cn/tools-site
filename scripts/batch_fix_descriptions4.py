#!/usr/bin/env python3
"""Batch fix descriptions - round 4: target 140-160 chars for Chinese, add more value props."""
import re
from pathlib import Path

fixes = [
    ("voltage-drop-calculator/index.html",
     "免费在线电压降计算器，快速计算直流和交流电路的电压降和百分比。输入导线长度、截面积和负载电流，自动计算电压降并评估是否符合NEC/IEC标准。帮助电工和工程师选择合适的导线规格，确保电路安全运行。纯前端处理数据不上传服务器，即开即用无需注册完全免费。"),
    ...
    ("rich-text-editor/index.html",
     "免费在线富文本编辑器，可视化编辑文字内容，支持实时预览HTML源码和下载HTML文件。提供加粗、斜体、列表、表格、链接插入等完整编辑工具栏，操作直观方便。适合撰写文档、编辑邮件和快速排版使用。所有编辑内容在浏览器本地完成，无需注册完全免费。"),

    ("image-mirror/index.html",
     "免费在线图片镜像翻转工具，支持水平翻转和垂直翻转两种模式，支持JPG、PNG、WebP、GIF等常见图片格式。纯前端Canvas处理图片不上传服务器，保护隐私安全。适合设计师调整构图方向、社交媒体运营制作创意图片等场景，即开即用无需注册完全免费。"),

    ("fuel-efficiency/index.html",
     "免费在线油耗计算器，支持L/100km、MPG、km/L等多种单位实时切换。输入加油量和行驶里程即可精准计算百公里油耗，帮助车主管理日常用车成本和对比不同车型的燃油经济性。纯前端处理数据不上传服务器，无需注册完全免费使用。"),
    ...
    ("net-worth-calculator/index.html",
     "免费在线净资产计算器，净资产=总资产减去总负债，是衡量个人或家庭财务健康的核心指标。输入现金存款、投资理财、房产车辆等资产和贷款债务明细，快速计算净资产总额。帮助做好家庭财务规划和资产追踪，纯前端处理数据安全有保障，即开即用无需注册完全免费。"),
    ...
    ("circle-calculator/index.html",
     "免费在线圆形计算器，输入半径或直径自动计算圆的面积、周长、直径和半径。显示π公式和分步计算过程，支持厘米/米/英寸多单位实时切换。适合学生学习几何知识、工程师进行图纸计算和日常尺寸换算使用。纯前端运算即开即用，无需注册完全免费。"),

    ("forex-pip-calculator/index.html",
     "免费在线外汇点值计算器，支持EUR/USD、GBP/JPY等所有主流货币对及交叉盘交易品种。帮助外汇交易者精确计算每点价值，科学进行仓位管理和风险控制。输入交易手数和货币对即可得出精确点值结果。纯前端处理数据不上传服务器，无需注册完全免费。"),

    ("percentage-difference-calculator/index.html",
     "免费在线百分比差异计算器，计算两个数值之间的百分比差异、绝对差异和相对差异三项指标。适合统计数据分析、实验误差评估和双数据源对比等多种场景使用。输入两个数值即可自动计算输出结果，纯客户端本地运算数据不上传服务器，无需注册即可免费使用。"),

    ("word-density-analyzer/index.html",
     "免费在线词频密度分析器，统计文本中每个词语的出现频率和密度百分比，自动计算TF-IDF权重。支持中英文分词、停用词过滤和词云可视化展示。SEO优化师分析关键词分布、内容创作者检查文章写作质量的必备工具。纯前端处理数据不上传服务器，无需注册完全免费。"),

    ("keyword-density-analyzer/index.html",
     "免费在线关键词密度分析器，分析文章中每个词的出现频率和密度百分比。支持排除停用词、按频率排序和词频统计可视化功能。帮助SEO优化师优化关键词分布避免堆砌被搜索引擎降权，内容创作者检查文章写作质量。纯前端处理数据不上传服务器，无需注册完全免费。"),
