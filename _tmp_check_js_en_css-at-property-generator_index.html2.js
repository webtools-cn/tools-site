...
if(!name){showToast('PleaseInputattributename');return}
if(!syntax){showToast('');return}
if(!initial){showToast('PleaseInputinitialstartvalue');return}
...
showToast('CSS @propertyGeneratecomplete');
}
function downloadOutput(){
var text=document.getElementById('output').textContent;
if(!text||text===''){showToast('');return}
